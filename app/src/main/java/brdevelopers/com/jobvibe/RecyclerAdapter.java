                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if(success.equals("1"))
                        {
                            ...
                            androidx.appcompat.app.AlertDialog.Builder message= new androidx.appcompat.app.AlertDialog.Builder(context);

                            View v=inflater.inflate(R.layout.success_layout,null);
                            message.setView(v);
                            TextView okay=(TextView) v.findViewById(R.id.TV_okay);
                            final androidx.appcompat.app.AlertDialog dialog = message.create();
